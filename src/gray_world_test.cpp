...
int main(){
    Mat image1 = imread("/home/harsha/Pictures/auv_8.png");
    Mat image_hsv;
    Mat image;

    image = clahe_conversion(image1);

    addWeighted(image,0.7, image1, 0.3, 0.0, image);
    ...
    vector<Mat>hsv;
    split(image_hsv, hsv);
    imwrite("/home/harsha/Pictures/clahee3.JPG",image);
