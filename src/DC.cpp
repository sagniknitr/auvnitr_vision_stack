...
int main(int argc, char* argv[]) {
    ...
    cv::Mat matImage = cv::imread("/home/shaggy/line_auv/heart.png");
    std::cout<<"Heloo"<<endl;
    ...
    Mat image1,imgHSV;
    image1 = imread("quantized.png");

    //cvtColor( image1, imgHSV, COLOR_BGR2HSV );

    
    /*Mat image2 = imread("/home/harsha/Pictures/AUV_1.png");
    Mat image3 = image2 - image1;
    Mat image4 = image3;
    imwrite("/home/harsha/Pictures/image4.png",image4);
    ...
    for(int y=0; y<image3.rows; y++){
        for(int x=0; x<image3.cols; x++){
            if(image3.at<cv::Vec3b>(y,x)[1] <= image3.at<cv::Vec3b>(y,x)[2]+ 10 && image3.at<cv::Vec3b>(y,x)[2] >= 10 +image3.at<cv::Vec3b>(y,x)[0]  && image3.at<cv::Vec3b>(y,x)[1] <=10 && image3.at<cv::Vec3b>(y,x)[0] <=10 && image3.at<cv::Vec3b>(y,x)[2] <=35){
                image3.at<cv::Vec3b>(y,x)[0] = 255;
                image3.at<cv::Vec3b>(y,x)[1] = 255;
                image3.at<cv::Vec3b>(y,x)[2] = 255;
            }
            else{
                image3.at<cv::Vec3b>(y,x)[0] = 0;
                image3.at<cv::Vec3b>(y,x)[1] = 0;
                image3.at<cv::Vec3b>(y,x)[2] = 0;
            }
        }
    }
    imshow("ssdjk",image3);
